      ...
      <h2 class="about__title">About</h2>
        ...
        <div class="about__grid">
          ...
          <p class="about__body">
            ...
            趣味はアニメやゲームで、興味を持った物事には挑戦するよう努めており、Blenderを独学で学び、3DCGの作品を制作したり、他にも、Webサイトのアニメーション実装にも挑戦し、よりアニメーションの表現に魅力を感じるようになりました。<br>

            2025年4月にトライデントコンピュータ専門学校のWebデザイン学科に入学し、HTML、CSS、JavaScriptを本格的に学び始めました。授業内でブログや進級展でのWebサイト制作においてWordPressに触れてからCMSにも興味を持って、個人でPHPを学び、データベースも構築して、このポートフォリオサイトもPHPで独自の更新機能を配置して作成しています。
          </p>
